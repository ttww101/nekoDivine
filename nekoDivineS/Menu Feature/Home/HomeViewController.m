...
@property (nonatomic, strong) NekoViewController *feature1VC;
...
- (void)viewDidLoad {
    ...
    [dVC setStartPage:@"https://tknutf.github.io/PrivacyPolicy.html"];
...
- (void)setContainerViewController {
    NekoViewController *vc1 = [NekoViewController new];
...
- (void)setupNavigationStyle {
    NavigationTheme *theme = [[NavigationTheme alloc]
                              ...
                              //title font, size
                              titleAttributes:@{                                                                            NSFontAttributeName:[UIFont boldSystemFontOfSize:20],                                                         NSForegroundColorAttributeName:[UIColor colorWithRed:255.0f/255.0f
                                                                                                                                                                                                                                                                                         green:233.0f/255.0f
                                                                                                                                                                                                                                                                                          blue:190.0f/255.0f
                                                                                                                                                                                                                                                                                         alpha:1.0f]                                                                             }];
        ...
        if (i == button.tag) {
            ...
            switch (button.tag) {
                case 0:
                {
                    ...
                    NekoViewController *controllerD = [storyboard instantiateViewControllerWithIdentifier:@"0"];
